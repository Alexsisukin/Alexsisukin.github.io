CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_user` (
        `id` INT NOT NULL AUTO_INCREMENT,
         `user_en` INT(11) NULL, `user_ru` INT(11) NULL,
        `dt_create` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_new_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_fail_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_repeat_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_order_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_sum_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_paypal_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_paypal_order` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_robokassa_pay` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_robokassa_order` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_expired_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_expired_tariff_users` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_expired_tariff_calc` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_buy_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_self_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_upgrade_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_downgrade_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_all_pay_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_new_calc` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_publish_calc` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_exist_publish_calc` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_sms_total` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_sms_client` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_sms_admin` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_email_total` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_email_client` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_email_admin` (
        `id` INT NOT NULL AUTO_INCREMENT,
        ...
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_top_tariff` (
        `id` INT NOT NULL AUTO_INCREMENT,
         `tariff_id` INT(11) NULL, `use_tariff` INT(11) NULL,
        `dt_create` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        PRIMARY KEY (`id`))
        ENGINE = InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE IF NOT EXISTS ucalc_log.`day_statistic_top_tariff_use` (
        `id` INT NOT NULL AUTO_INCREMENT,
         `tariff_id` INT(11) NULL, `use_tariff` INT(11) NULL,
        `dt_create` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
        PRIMARY KEY (`id`))
